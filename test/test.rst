      ...
      000062                        358 _main:
                           ...
                           000001   365 	ar1 = 0x01
                           000000   366 	ar0 = 0x00
                                    367 ;	test.c:6: while(1){
      000062                        368 00105$:
                                    369 ;	test.c:7: if(a = 1){
      000062 D2 93            [12]  370 	setb	_P1_3
                                    371 ;	test.c:8: a = 0;
      000064 10 93 FB         [24]  372 	jbc	_P1_3,00105$
                                    373 ;	test.c:10: a = 1;
      000067 D2 93            [12]  374 	setb	_P1_3
      000069 80 F7            [24]  375 	sjmp	00105$
                                    376 	.area CSEG    (CODE)
                                    377 	.area CONST   (CODE)
                                    378 	.area XINIT   (CODE)
