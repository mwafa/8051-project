      ...
      000000                        218 	.ds 8
                                    ...
                                    283 ;------------------------------------------------------------
                                    284 ;	vid_6.c:3: void _main_(void) __naked
                                    285 ;	-----------------------------------------
                                    286 ;	 function _main_
                                    287 ;	-----------------------------------------
      000000                        288 __main_:
                                    289 ;	naked function: no prologue.
                                    290 ;	vid_6.c:5: while(1){
      000000                        291 00102$:
                                    292 ;	vid_6.c:6: P1 = (P1 == 0xFF) ? 0 : P1|(P1+1);
      000000 74 FF            [12]  293 	mov	a,#0xff
      000002 B5 90 04         [24]  294 	cjne	a,_P1,00106$
      000005 7F 00            [12]  295 	mov	r7,#0x00
      000007 80 06            [24]  296 	sjmp	00107$
      000009                        297 00106$:
      000009 E5 90            [12]  298 	mov	a,_P1
      00000B 04               [12]  299 	inc	a
      00000C 45 90            [12]  300 	orl	a,_P1
      00000E FF               [12]  301 	mov	r7,a
      00000F                        302 00107$:
      00000F 8F 90            [24]  303 	mov	_P1,r7
      000011 80 ED            [24]  304 	sjmp	00102$
                                    305 ;	naked function: no epilogue.
                                    306 	.area CSEG    (CODE)
                                    307 	.area CONST   (CODE)
                                    308 	.area XINIT   (CODE)
