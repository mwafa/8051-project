      ...
      000000                        218 	.ds 8
                                    ...
                                    283 ;------------------------------------------------------------
                                    284 ;	vid_1.c:4: void _main_(void) __naked
                                    285 ;	-----------------------------------------
                                    286 ;	 function _main_
                                    287 ;	-----------------------------------------
      000000                        288 __main_:
                                    289 ;	naked function: no prologue.
                                    290 ;	vid_1.c:6: P1 = 0b10101010;
      000000 75 90 AA         [24]  291 	mov	_P1,#0xaa
                                    292 ;	vid_1.c:7: while(1){P1 = ~P1;}
      000003                        293 00102$:
      000003 E5 90            [12]  294 	mov	a,_P1
      000005 F4               [12]  295 	cpl	a
      000006 F5 90            [12]  296 	mov	_P1,a
      000008 80 F9            [24]  297 	sjmp	00102$
                                    298 ;	naked function: no epilogue.
                                    299 	.area CSEG    (CODE)
                                    300 	.area CONST   (CODE)
                                    301 	.area XINIT   (CODE)
