      ...
      000000                        218 	.ds 8
                                    ...
                                    283 ;------------------------------------------------------------
                                    284 ;	vid_3.c:3: void _main_(void) __naked
                                    285 ;	-----------------------------------------
                                    286 ;	 function _main_
                                    287 ;	-----------------------------------------
      000000                        288 __main_:
                                    289 ;	naked function: no prologue.
                                    290 ;	vid_3.c:5: P1 = 0b01111111;
      000000 75 90 7F         [24]  291 	mov	_P1,#0x7f
                                    292 ;	vid_3.c:6: while(1){
      000003                        293 00102$:
                                    294 ;	vid_3.c:7: P1 = (P1 == 0b11111110) ? 0b01111111 :(P1>>1)+ 0b10000000;
      000003 74 FE            [12]  295 	mov	a,#0xfe
      000005 B5 90 04         [24]  296 	cjne	a,_P1,00106$
      000008 7F 7F            [12]  297 	mov	r7,#0x7f
      00000A 80 08            [24]  298 	sjmp	00107$
      00000C                        299 00106$:
      00000C E5 90            [12]  300 	mov	a,_P1
      00000E C3               [12]  301 	clr	c
      00000F 13               [12]  302 	rrc	a
      000010 FE               [12]  303 	mov	r6,a
      000011 24 80            [12]  304 	add	a,#0x80
      000013 FF               [12]  305 	mov	r7,a
      000014                        306 00107$:
      000014 8F 90            [24]  307 	mov	_P1,r7
      000016 80 EB            [24]  308 	sjmp	00102$
                                    309 ;	naked function: no epilogue.
                                    310 	.area CSEG    (CODE)
                                    311 	.area CONST   (CODE)
                                    312 	.area XINIT   (CODE)
