      ...
      000000                        218 	.ds 8
                                    ...
                                    283 ;------------------------------------------------------------
                                    284 ;	vid_2.c:3: void _main_(void) __naked
                                    285 ;	-----------------------------------------
                                    286 ;	 function _main_
                                    287 ;	-----------------------------------------
      000000                        288 __main_:
                                    289 ;	naked function: no prologue.
                                    290 ;	vid_2.c:5: P1 = 0b11111110;
      000000 75 90 FE         [24]  291 	mov	_P1,#0xfe
                                    292 ;	vid_2.c:6: while(1){
      000003                        293 00102$:
                                    294 ;	vid_2.c:7: P1 = (P1 == 0b01111111) ? 0b11111110 :(P1<<1)+1;
      000003 74 7F            [12]  295 	mov	a,#0x7f
      000005 B5 90 04         [24]  296 	cjne	a,_P1,00106$
      000008 7F FE            [12]  297 	mov	r7,#0xfe
      00000A 80 07            [24]  298 	sjmp	00107$
      00000C                        299 00106$:
      00000C E5 90            [12]  300 	mov	a,_P1
      00000E 25 E0            [12]  301 	add	a,acc
      000010 FE               [12]  302 	mov	r6,a
      000011 04               [12]  303 	inc	a
      000012 FF               [12]  304 	mov	r7,a
      000013                        305 00107$:
      000013 8F 90            [24]  306 	mov	_P1,r7
      000015 80 EC            [24]  307 	sjmp	00102$
                                    308 ;	naked function: no epilogue.
                                    309 	.area CSEG    (CODE)
                                    310 	.area CONST   (CODE)
                                    311 	.area XINIT   (CODE)
