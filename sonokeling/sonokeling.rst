      ...
      00000A                        274 	.ds 2
                                    ...
                                    332 	.area CSEG    (CODE)
                                    333 ;------------------------------------------------------------
                                    334 ;Allocation info for local variables in function '_main_'
                                    335 ;------------------------------------------------------------
                                    336 ;	sonokeling.c:7: void _main_(void) __naked
                                    337 ;	-----------------------------------------
                                    338 ;	 function _main_
                                    339 ;	-----------------------------------------
      000000                        340 __main_:
                                    341 ;	naked function: no prologue.
                                    342 ;	sonokeling.c:9: while (1){
      000000                        343 00105$:
                                    344 ;	sonokeling.c:10: a = 1;
      000000 75 08 01         [24]  345 	mov	_a,#0x01
      000003 75 09 00         [24]  346 	mov	(_a + 1),#0x00
                                    347 ;	sonokeling.c:11: b = 0b10000000;
      000006 75 0A 80         [24]  348 	mov	_b,#0x80
      000009 75 0B 00         [24]  349 	mov	(_b + 1),#0x00
                                    350 ;	sonokeling.c:12: while(b>0)
      00000C                        351 00101$:
      00000C C3               [12]  352 	clr	c
      00000D E4               [12]  353 	clr	a
      00000E 95 0A            [12]  354 	subb	a,_b
      000010 74 80            [12]  355 	mov	a,#(0x00 ^ 0x80)
      000012 85 0B F0         [24]  356 	mov	b,(_b + 1)
      000015 63 F0 80         [24]  357 	xrl	b,#0x80
      000018 95 F0            [12]  358 	subb	a,b
      00001A 50 E4            [24]  359 	jnc	00105$
                                    360 ;	sonokeling.c:14: P1 ^= a+b;
      00001C AF 08            [24]  361 	mov	r7,_a
      00001E E5 0A            [12]  362 	mov	a,_b
      000020 2F               [12]  363 	add	a,r7
      000021 FF               [12]  364 	mov	r7,a
      000022 AE 90            [24]  365 	mov	r6,_P1
      000024 6E               [12]  366 	xrl	a,r6
      000025 F5 90            [12]  367 	mov	_P1,a
                                    368 ;	sonokeling.c:15: a <<=1;
      000027 E5 09            [12]  369 	mov	a,(_a + 1)
      000029 C5 08            [12]  370 	xch	a,_a
      00002B 25 E0            [12]  371 	add	a,acc
      00002D C5 08            [12]  372 	xch	a,_a
      00002F 33               [12]  373 	rlc	a
      000030 F5 09            [12]  374 	mov	(_a + 1),a
                                    375 ;	sonokeling.c:16: b >>=1;
      000032 E5 0B            [12]  376 	mov	a,(_b + 1)
      000034 A2 E7            [12]  377 	mov	c,acc.7
      000036 13               [12]  378 	rrc	a
      000037 C5 0A            [12]  379 	xch	a,_b
      000039 13               [12]  380 	rrc	a
      00003A C5 0A            [12]  381 	xch	a,_b
      00003C F5 0B            [12]  382 	mov	(_b + 1),a
      00003E 80 CC            [24]  383 	sjmp	00101$
                                    384 ;	naked function: no epilogue.
                                    385 	.area CSEG    (CODE)
                                    386 	.area CONST   (CODE)
                                    387 	.area XINIT   (CODE)
